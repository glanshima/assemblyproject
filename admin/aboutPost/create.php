...
<head>
    ...
    <title>Admin Section - Add About</title>
</head>
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                <h2 class="page-title">Add About</h2>
 ...
 -->
                    ...
                    <div>
                        <label>Body</label>
                        <textarea name="body" id="body"><?php echo $body; ?>
                    </textarea>
                    ...
                    <div>
                        <button type="submit" name="add-about" class="btn btn-big">Add About</button>
