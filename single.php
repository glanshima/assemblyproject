...
if (isset($_GET['id'])) {
    $commissioner = selectOne('commissioners', ['id' => $_GET['id']]);
}
        ...
        <div class="content single">
            ...
            <div class="main-content-wrapper single">
                <div class="main-content single">
                    <h1 class="post-title single title-h1 main-section-title "> <?php echo $commissioner['title']; ?>
                    </h1>
                    <div class="post-content about">
                        ...
                        <?php echo html_entity_decode($commissioner['body']); ?>
                    </div>
