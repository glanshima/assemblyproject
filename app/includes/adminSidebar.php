<div class="left-sidebar">
    <ul>
        <li><a href="<?php echo BASE_URL . '/admin/commissioners/index.php'; ?>">Manage Commissioners</a></li>
        ...
        <li><a href="<?php echo BASE_URL . '/admin/aboutPost/index.php'; ?>">Manage About</a></li>
